...
func TestOpenAIChatRequestToClaudeMessagesConvertsTextFileToTextBlock(t *testing.T) {
	...
	relaymedia.SetMediaResolver(relaymedia.MediaResolver{
		GetBase64Data: func(_ context.Context, _ types.FileSource, _ ...string) (string, string, error) {
	...
	request, err := OpenAIChatRequestToClaudeMessages(context.Background(), nil, dto.GeneralOpenAIRequest{
