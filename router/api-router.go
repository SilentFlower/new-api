	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/billing-summary", controller.GetAdminUserBillingSummaries)
		...
		messageAuditRoute := apiRouter.Group("/message-audit")
		messageAuditRoute.Use(middleware.RootAuth())
		{
		...
		systemTaskRoute.Use(middleware.RootAuth())
		{
			...
			systemTaskRoute.POST("/message-audit-cleanup", controller.CreateMessageAuditCleanupSystemTask)
		...
		dataRoute.GET("/token-names", middleware.AdminAuth(), controller.GetAllTokenNames)
		dataRoute.GET("/system-stats", middleware.AdminAuth(), controller.GetSystemStats)
		dataRoute.GET("/flow", middleware.AdminAuth(), controller.GetAllFlowQuotaDates)
		dataRoute.GET("/flow/self", middleware.UserAuth(), controller.GetUserFlowQuotaDates)

		logRoute.Use(middleware.CORS(), middleware.GlobalAPIRateLimit())
		{
