...
var auditContentTemplates = map[string]string{
	...
	"channel.period_policy_set":           "Updated period policy for channel ${channel_id} to revision ${revision}",
	"channel.user_period_override_set":    "Updated period quota override for user ${user_id} on channel ${channel_id}",
	"channel.user_period_override_delete": "Removed period quota override for user ${user_id} on channel ${channel_id}",
	...
	"channel.user_daily_quota_set":        "Set daily used quota for user ${user_id} on channel ${channel_id} to ${used_quota}",
