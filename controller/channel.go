...
func validateChannel(channel *model.Channel, isAdd bool) error {
	...
	if err := validateChannelUserWeeklyQuotaLimit(channel.UserWeeklyQuotaLimit); err != nil {
		return err
	}
	// 校验 channel settings
...
func UpdateChannel(c *gin.Context) {
	...
	normalizeChannelUserWeeklyQuotaLimitForUpdate(&channel.Channel, requestData)
	...
	if channel.GetUserWeeklyQuotaLimit() != originChannel.GetUserWeeklyQuotaLimit() {
		changedFields = append(changedFields, "user_weekly_quota_limit")
	}
